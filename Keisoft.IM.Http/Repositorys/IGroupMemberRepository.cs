...
namespace Keisoft.IM.Http.Repositorys
{
    internal interface IGroupMemberRepository
    {
        ...
        /// <exception cref="System.Exception"> 数据库操作异常。</exception>
        internal Task DeleteAllAsync(int groupId);
        ...
        /// <returns> 异步任务对象。</returns>
        /// <exception cref="System.Exception"> 数据库操作异常。</exception>
        internal Task DeleteAsync(int groupId, int memberId);

        /// <summary>
        /// 删除群成员。
        /// </summary>
        /// <param name="groupId"> 群 Id。</param>
        /// <param name="memberIds"> 成员 Id 集合。</param>
        /// <returns> 异步任务对象。</returns>
        /// <exception cref="System.Exception"> 数据库操作异常。</exception>
        internal Task DeleteRangeAsync(int groupId, List<int> memberIds);

        /// <summary>
        /// 插入群成员。
        /// </summary>
        /// <param name="groupMember"> 群成员。</param>
        /// <returns> 异步任务对象。</returns>
        /// <exception cref="System.Exception"> 数据库操作异常。</exception>
        internal Task InsertAsync(GroupMember groupMember);

        /// <summary>
        /// 插入群成员。
        /// </summary>
        /// <param name="groupMembers"> 群成员集合。</param>
        /// <returns> 异步任务对象。</returns>
        /// <exception cref="System.Exception"> 数据库操作异常。</exception>
        internal Task InsertRangeAsync(List<GroupMember> groupMembers);
    }
}
