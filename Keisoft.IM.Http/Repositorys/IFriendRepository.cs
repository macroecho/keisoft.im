...
namespace Keisoft.IM.Http.Repositorys
{
    internal interface IFriendRepository
    {
        ...
        /// 插入好友数据。
        /// </summary>
        /// <param name="friends"> 好友数据。</param>
        /// <returns> 异步任务对象。</returns>
        /// <exception cref="Exception"> 数据库操作异常。</exception>
        internal Task InsertAsync(Friend friend);
        ...
        /// <returns></returns>
        internal Task InsertAsync(int meId, int heId);
        ...
        /// <returns></returns>
        internal Task InsertAsync(int meId, int[] heIds);
        ...
        /// <returns></returns>
        /// <exception cref="Exception"> 数据库操作异常。</exception>
        internal Task DeleteAsync(int meId, int heId);
    }
}
