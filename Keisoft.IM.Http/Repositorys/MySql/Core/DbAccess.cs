...
namespace Keisoft.IM.Http.Repositorys.MySql
{
    internal class DbAccess : IDisposable
    {
        ...
        {
            var cmd = CreateCommand(new DbCmdParameter
            {
                Text = sql,
        ...
        internal int ExecuteNonQuery(string sql, Dictionary<string, object> parameters = null, MySqlTransaction transaction = null)
        {
            using var cmd = CreateCommand(new DbCmdParameter
            {
                Text = sql,
        ...
        internal void ExecuteNonQuery(string sql, List<Dictionary<string, object>> list, MySqlTransaction transaction = null)
        {
            if (list == null)
            {
        ...
        {
            var cmd = await CreateCommandAsync(new DbCmdParameter
            {
                Text = sql,
                Type = CommandType.Text
            }, cancellationToken);
        ...
        internal async Task<int> ExecuteNonQueryAsync(string sql, Dictionary<string, object> parameters, MySqlTransaction transaction = null, CancellationToken cancellationToken = default)
        {
            using var cmd = await CreateCommandAsync(new DbCmdParameter
            {
                Text = sql,
        ...
        internal async Task<int> ExecuteNonQueryAsync(string sql, List<Dictionary<string, object>> list, MySqlTransaction transaction = null, CancellationToken cancellationToken = default)
        {
            var result = 0;
