...
namespace Keisoft.IM.Http.Services
{
    public interface IGroupMemberService
    {
        ...
        /// <exception cref="System.Exception"> 添加出现异常。</exception>
        internal Task AddAsync(int groupId, int memberId);
        ...
        /// <returns> 异步任务对象。</returns>
        /// <exception cref="System.Exception"> 添加出现异常。</exception>
        internal Task AddAsync(int groupId, List<int> memberIds);
        ...
        /// <param name="groupId"> 群 Id。</param>
        /// <returns> 异步任务对象。</returns>
        /// <exception cref="System.Exception"> 移除出现异常。</exception>
        internal Task RemoveAllAsync(int groupId);
        ...
        /// <returns> 异步任务对象。</returns>
        /// <exception cref="System.Exception"> 移除出现异常。</exception>
        internal Task RemoveAsync(int groupId, int memberId);
        ...
        /// <returns> 异步任务对象。</returns>
        /// <exception cref="System.Exception"> 移除出现异常。</exception>
        internal Task RemoveAsync(int groupId, List<int> memberIds);
    }
}
