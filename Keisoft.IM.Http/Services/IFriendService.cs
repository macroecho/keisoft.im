...
namespace Keisoft.IM.Http.Services
{
    public interface IFriendService
    {
        ...
        /// 双向添加好友。
        /// </summary>
        /// <param name="meId"> 我的用户 Id。</param>
        /// <param name="heId"> 好友的用户 Id。</param>
        /// <returns></returns>
        /// <exception cref="Exception"> 添加失败的异常。</exception>
        internal Task AddAsync(int meId, int heId);

        /// <summary>
        /// 双向添加好友（一对多）。
        /// </summary>
        /// <param name="meId"> 我的用户 Id。</param>
        /// <param name="heIds"> 好友的用户 Id。</param>
        /// <returns></returns>
        /// <exception cref="Exception"> 添加失败的异常。</exception>
        internal Task AddAsync(int meId, int[] heIds);
        ...
        /// <returns></returns>
        /// <exception cref="Exception"> 添加失败的异常。</exception>
        internal Task AddOnewayAsync(int meId, int heId);
        ...
        /// <param name="heId"> 好友的用户 Id。</param>
        /// <returns></returns>
        /// <exception cref="Exception"> 移除失败的异常。</exception>
        internal Task RemoveAsync(int meId, int heId);
    }
}
