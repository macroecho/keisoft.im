...
namespace Keisoft.IM.Http.Exceptions
{
    ...
    /// 当参数非法时引发的异常。
    /// </summary>
    public class ArgIllegaException : System.Exception
    {
        ...
        /// 获取异常代码。
        /// </summary>
        public string Code { get { return "ArgIllegal"; } }

        /// <summary>
        /// 初始化 Keisoft.IM.Http.Exceptions.ArgIllegaException 的实例。
        /// </summary>
        public ArgIllegaException() : base("参数非法")
        {
        ...
        public ArgIllegaException(string paramName) : this()
        {
