...
namespace Keisoft.IM.Http.Exceptions
{
    ...
    /// 执行失败时引发的异常。
    /// </summary>
    public class FailureException : System.Exception
    {
        private string _code = "Failure";
        ...
        /// <summary>
        /// 初始化 Keisoft.IM.Http.Exceptions.FailureException 的实例。
        /// </summary>
        public FailureException() : base("执行失败")
        {
        ...
        /// <param name="message"> 描述错误的消息。</param>
        public FailureException(string code, string message) : base(message)
        {
            _code = code;
        }
