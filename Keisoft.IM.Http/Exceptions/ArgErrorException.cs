...
namespace Keisoft.IM.Http.Exceptions
{
    /// <summary>
    /// 当参数错误引发的异常。
    /// </summary>
    public class ArgErrorException : System.Exception
    {
        private string _paramName;
        private string _code = "ArgError";
        ...
        /// <summary>
        /// 初始化 Keisoft.IM.Http.Exceptions.ArgErrorException 的实例。
        /// </summary>
        public ArgErrorException() : base("参数错误")
        {
        ...
        public ArgErrorException(string paramName, string message) : base(message)
        {
        ...
        /// <param name="message"> 描述错误的消息。</param>
        public ArgErrorException(string paramName, string code, string message) : base(message)
        {
            _paramName = paramName;
            _code = code;
        }
