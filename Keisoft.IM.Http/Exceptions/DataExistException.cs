...
namespace Keisoft.IM.Http.Exceptions
{
    ...
    {
        private string _code = "DataExist";
        ...
        /// <summary>
        /// 初始化 Keisoft.IM.Http.Exceptions.DataExistException 的实例。
        /// </summary>
        public DataExistException() : base("数据已存在")
        {
        ...
        /// <param name="message"> 描述错误的消息。</param>
        public DataExistException(string code, string message) : base(message)
        {
            _code = code;
        }
    }
