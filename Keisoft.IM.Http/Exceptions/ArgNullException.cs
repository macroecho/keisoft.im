...
namespace Keisoft.IM.Http.Exceptions
{
    ...
    /// 当参数为空时引发的异常。
    /// </summary>
    public class ArgNullException : System.Exception
    {
        ...
        /// 获取异常代码。
        /// </summary>
        public string Code { get { return "ArgNull"; } }

        /// <summary>
        /// 初始化  Keisoft.IM.Http.Exceptions.ArgNullException 的实例。
        /// </summary>
        public ArgNullException() : base("参数为空")
        {
        ...
        public ArgNullException(string paramName) : this()
        {
