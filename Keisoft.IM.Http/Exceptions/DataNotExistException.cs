...
namespace Keisoft.IM.Http.Exceptions
{
    ...
    public class DataNotExistException : System.Exception
    {
        ...
        private string _code = "DataNotExist";
        ...
        /// <summary>
        /// 初始化 Keisoft.IM.Http.Exceptions.DataNotExistException 的实例。
        /// </summary>
        public DataNotExistException() : base("数据不存在")
        {
        ...
        /// <param name="message"> 描述错误的消息。</param>
        public DataNotExistException(string code, string message) : base(message)
        {
            _code = code;
        }
