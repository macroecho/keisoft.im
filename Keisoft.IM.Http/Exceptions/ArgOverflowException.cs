...
namespace Keisoft.IM.Http.Exceptions
{
    ...
    /// 当参数溢出引发的异常。
    /// </summary>
    public class ArgOverflowException : System.Exception
    {
        ...
        /// 获取异常代码。
        /// </summary>
        public string Code { get { return "ArgOverflow"; } }

        /// <summary>
        /// 初始化  Keisoft.IM.Http.Exceptions.ArgOverflowException 的实例。
        /// </summary>
        public ArgOverflowException() : base("参数溢出")
        {
        ...
        public ArgOverflowException(string paramName) : this()
        {
        ...
        {
            return string.Concat(_paramName, " ", Message);
        }
    }
}
