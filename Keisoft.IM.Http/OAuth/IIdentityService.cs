...
namespace Keisoft.IM.Http.OAuth
{
    public interface IIdentityService
    {
        ...
        internal Task<int> GetIdAsync();

        /// <summary>
        /// 身份验证。
        /// </summary>
        /// <param name="token"> 令牌。</param>
        /// <returns> 身份验证成功为 true；否则为 false。</returns>
        internal bool Authentication(string token);
        ...
        /// <exception cref="AuthenticationException"> 身份认证异常。</exception>
        internal IdentityOutput ToIdentityOutput(string token);
        ...
        /// <returns></returns>
        internal string Create(int uid, PlatformTypeEnum platform, string deviceNo, long timeStamp);
    }
}
