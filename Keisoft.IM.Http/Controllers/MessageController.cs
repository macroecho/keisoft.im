...
namespace Keisoft.IM.Http.Controllers
{
    ...
    public class MessageController : ControllerBase
    {
        ...
        public MessageController(IIdentityService identityService, IMessageService messageService)
        {
        ...
        public async Task<ActionResult> GetPrivateListAsync([FromQuery] QueryMessageInput queryMessageInput)
        {
            queryMessageInput.UId = await _identityService.GetIdAsync();

            var cancellationToken = HttpContext.RequestAborted;
            var result = await _messageService.GetPrivateListAsync(queryMessageInput, cancellationToken);

            return result.ToJson();
        }

        [HttpGet, Route("Group")]
        public async Task<ActionResult> GetGroupListAsync([FromQuery] QueryMessageInput queryMessageInput)
        {
            queryMessageInput.UId = await _identityService.GetIdAsync();

            var cancellationToken = HttpContext.RequestAborted;
            var result = await _messageService.GetGroupListAsync(queryMessageInput, cancellationToken);
