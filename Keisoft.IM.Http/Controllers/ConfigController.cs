...
namespace Keisoft.IM.Http.Controllers
{
    ...
    {
        private readonly string[] _tcpServiceAddress;

        public ConfigController(IMServiceOptions imServiceOptions)
        {
            _tcpServiceAddress = imServiceOptions.TcpServiceAddress;
        }

        [HttpGet, Route("TcpServiceAddress")]
        public ActionResult GetTcpServiceAddress()
        {
            return _tcpServiceAddress.ToJson();
        }
    }
}
